  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-dark">
    ...
    <div class="position-sticky bg-dark">
      <div class="list-group list-group-flush mx-3 mt-4">
        <a onclick="window.location.href='dashboard'" class="list-group-item list-group-item-action zoom bg-dark text-white">
                ...
                <div class="col-md-6 mt-2">
                    <div class="card" style="background-color: white;">
                        <div class="card-content">
                            <div class="card-body">
                            <center><div class="">Personal Info</div></center>
                                    <div class="line"></div><br>
                                    <CENTER><div class="mt-1 h1"><i class="fa-solid fa-people-group"></i></div></CENTER> 
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label">Name:</label><br>
                                            <label class="form-label">Shashi</label>
                                        </div><br>
                                        <div class="col-md-6">
                                            <label class="form-label">Email:</label><br>
                                            <label class="form-label">shashi@machintell.in</label>
                                        </div><br>
                                    </div><br><br>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label">Device Id:</label><br>
                                            <label class="form-label">TCSENSE-0001</label>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Contact No:</label><br>
                                            <label class="form-label">7002533125</label>
                                        </div>
                                    </div><br>
                            </div>
                        </div>
